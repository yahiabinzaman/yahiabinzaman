<div align="center">
  ...
  <p align="center">
    <strong>Crafting engaging web experiences, scalable applications & thoughtful designs.</strong>
  </p>
...
const yahia = {
  ...
  technologies: {
    ...
    design: ["Figma", "Adobe Photoshop", "Illustrator", "UI/UX Architecture"]
  },
  currentFocus: "Building modern full-stack web applications & creative software",
  passion: ["Clean Code", "Pixel-Perfect UI", "Open Source", "Creative Typography"],
  funFact: "Bridging the gap between software engineering & visual design 🎨💻"
};
```

- 🔭 **I’m currently working on**: Interactive web applications and open-source tooling.
- 🌱 **I’m currently learning**: Advanced cloud architecture & full-stack optimizations.
- 💬 **Ask me about**: Frontend development, UI/UX design, React/Next.js, and design systems.
- ⚡ **Hobby**: Graphic design, typography, and exploring modern UI trends.
...
<div align="center">
  <sub>Designed with ❤️ by <strong>Yahia Bin Zaman</strong></sub>
</div>
